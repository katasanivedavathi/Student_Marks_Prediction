...
app = Flask(__name__)
model = joblib.load(r"D:\Nareshit Videos and notes\Omkar Sir-FSDS & GenAI\FSDS&GENAI_Notes\Projects\Flask\student_mark_price_prediction\student_mark_predictor.pkl")
